...
const lastTdee: string | null = tdee.value ? tdee.value : localStorage.getItem('tdee');

const config = ref<VueUiVerticalBarConfig>({
  responsive: false,
  theme: '',
  customPalette: [],
  ...
  style: {
    ...
    chart: {
      ...
      tooltip: {
        ...
        customFormat: null,
        borderRadius: 4,
        borderColor: 'rgba(225, 229, 232, 1)',
        borderWidth: 1,
